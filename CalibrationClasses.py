...
## attempted Question 4 in this sections ##
...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            mean = multiCohort.simulate(CalibSets.TIME_STEPS)
            ...
            # problem 2: not dealing with normal distribution but instead binomial distribution CHECK
