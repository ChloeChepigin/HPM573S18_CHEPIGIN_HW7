## contains my answers to questions 1 - 3 (although more work for  1 and 3 are found in the "RunSteadyState" file
## Question 4 work is found in the "CalibrationClasses" and "CalirationSettings" files
...
class Cohort:
    ...
    def fiveyearsurvive(self):
        countsurvive = 0

        for value in self._survivalTimes:
            if value >5:
                countsurvive += 1
        return countsurvive / len(self._survivalTimes)
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._cohort_fiveyear_survival = []
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            #store five year survival
            self._cohort_fiveyear_survival.append(cohort.fiveyearsurvive())
    ...
    def get_fiveyearsuvival_list(self):
        return self._cohort_fiveyear_survival

## Question 1 ##
# the print function was put into the "RunStreadyState" py file where the probability was found to 0.58

## Question 2 ##
# I would think that this follows a binomial distribution as either a participant lives beyond five years or not
# The parameters include:
#   having a fixed number of observations
#   each observation is independent
#   each observation has one of two outcomes - in this case it's dead or alive at the five year mark
#   the probability of the outcome is the same for each


## Question 3 ##
likelihood=stat.binom.pmf(k=400, n=573, p=0.5)
print('the likelihood ratio is', stat.binom.pmf(k=400, n=573, p=0.5))
